...
function Header() {
  // const fnMenuStyle = (Active) => {}

  // const location = useLocation();
  // const menuStyle = (pathName) => {
    ...
    <header className="sticky top-0 z-50 border-b border-primary-100 backdrop-blur-xl bg-white/85">
      <div className="max-w-6xl mx-auto px-6 md:px-8 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-1">
          ...
          {/* <NavLink to="/todolist" className={menuStyle("/todolist")}> */}
          <NavLink
            to="/todolist"
          ...
          {/* <NavLink to="/example" className={menuStyle("/example")}> */}
          <NavLink
            to="/example"
            className={({ isActive }) => menuStyle(isActive)}
          >
          ...
          {/* <NavLink to="/counter" className={menuStyle("/example")}> */}
          <NavLink
            to="/counter"
            className={({ isActive }) => menuStyle(isActive)}
          >
